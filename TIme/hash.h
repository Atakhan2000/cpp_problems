...
namespace lab618
{
    ...
    */
    ...
    public:
        ...
        */
        CHash(int hashTableSize, int default_block_size) : m_tableSize(hashTableSize), m_Memory(CMemoryManager<leaf>(default_block_size, true))
        {
        ...
        */
        ...
        {
          unsigned int idx = 0;
          leaf* pElementLeaf = findLeaf(pElement, idx);

          if (nullptr != pElementLeaf)
          {
            return false;
          }
        ...
        */
        ...
        {
          unsigned int hash = HashFunc(&element);
